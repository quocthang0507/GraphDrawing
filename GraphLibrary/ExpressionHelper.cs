...
namespace GraphLibrary
{
	public class ExpressionHelper
	{
		...
		public static bool Polar { get => _polar; set => _polar = value; }
		public static double XStartValue { get => _xStartValue; set => _xStartValue = value; }
		public static double XEndValue { get => _xEndValue; set => _xEndValue = value; }
		public static bool BlnDo { get => _blnDo; set => _blnDo = value; }
		public static bool BlnRadian { get => _blnRadian; set => _blnRadian = value; }
	}
}
